...
GATLING_HOME=~chihiro/gatling-charts-highcharts-bundle-2.3.0
...
GATHER_REPORTS_DIR=/home/oracle/work/chihiro/reports/
...
do
  ...
  ssh -n -f $USER_NAME@$HOST "sh -c 'nohup $GATLING_RUNNER -nr -s $SIMULATION_NAME > $GATLING_HOME/log/run.log 2>&1 &'"
done
